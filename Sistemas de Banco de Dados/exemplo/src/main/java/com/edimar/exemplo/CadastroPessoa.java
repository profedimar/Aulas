...
public class CadastroPessoa extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            atualizarTabela();
            limparCampos();
            JOptionPane.showMessageDialog(null, "Pessoa inserida com sucesso!"); //definindo mensagem de sucesso
        } catch (SQLException | ClassNotFoundException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showMessageDialog(null, "Erro ao inserir a pessoa!"); //definindo mensagem de erro
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            atualizarTabela();
            limparCampos();
            JOptionPane.showMessageDialog(null, "Pessoa alterada com sucesso!");  //definindo mensagem de sucesso
        } catch (SQLException | ClassNotFoundException ex) {
            System.out.println(ex.getMessage());
            JOptionPane.showMessageDialog(null, "Erro ao alterar a pessoa!"); //definindo mensagem de erro
        }
    ...
    public void limparCampos(){
        codigo.setText(""); //para todos os campos de texto
        nome.setText(""); 
        sexo.setText(""); 
 }
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        if (selectedRow != -1) {
            int pk = Integer.parseInt(tabela.getValueAt(selectedRow, 0).toString());//a chave primária precisa estar na primeira coluna da tabela presente na tela, caso contrário tem que mudar aquele 0 para a posição da chave primária
            try {
                String sql = "SELECT codigo, nome, sexo FROM pessoa WHERE codigo=?"; //ALTERAR
                PreparedStatement ps = conexao.Conexao.getConexao().prepareStatement(sql);
                ps.setInt(1, pk);
                ResultSet rs = ps.executeQuery();
                while (rs.next()) {
                    codigo.setText(rs.getString("codigo")); //1 linha dessas para cada campo texto da tela
                    nome.setText(rs.getString("nome"));
                    sexo.setText(rs.getString("sexo"));
                }
            } catch (SQLException | ClassNotFoundException ex) {
                System.out.println(ex.getMessage());
                JOptionPane.showMessageDialog(null, "Erro ao carregar campos!");
            }
        } else {
